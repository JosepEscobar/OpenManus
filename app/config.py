...
# Número máximo de pasos para el agente Coordinador
# Define cuántos ciclos puede ejecutar para completar todas las subtareas
MAX_STEPS_COORDINATOR = 5000
