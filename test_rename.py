"""
Script de prueba para solicitar a OpenManus renombrar un archivo.
"""
import asyncio
import json
import time
...
async def test_rename():
    ...
    async with websockets.connect(uri) as websocket:
        ...
        message = {
            "type": "chat",
            "content": "Renombra el archivo test_file.txt a renamed_file.md y cambia su contenido a '# Archivo renombrado\n\nEste archivo ha sido renombrado con éxito.'",
            "sender": "user",
